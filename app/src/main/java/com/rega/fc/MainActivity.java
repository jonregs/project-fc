...
public class MainActivity extends AppCompatActivity {
    ...
    private FoodOfferAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodOfferList = new ArrayList<>();
        adapter = new FoodOfferAdapter(this, foodOfferList);
        ...
        //To be removed and replaced with asynchronous POST call method
        prepareFoodOffer();
